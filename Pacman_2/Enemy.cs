...
namespace Pacman_2
{
    public class Enemy
    {
        ...
        public Vector2 eatenTargetTile = new Vector2(13, 14); // supposed to be the inside of the  ghost house 
        ...
        protected Dir playerLastDir; // If the player direction is none, this remembers the last direction so that the ghost can know its target tile
        ...
        public Rectangle[] frightenedRects = new Rectangle[2]; // change values for these as well
        ...
        public void Update(GameTime gameTime, Controller gameController, Vector2 playerTilePos, Dir playerDir, Vector2 blinkyPos) // stops the ghosts from being frightened from the pellet after a specific amount of time
        {
        ...
        public virtual Vector2 getFrightenedTargetPosition()
        {
            ...
            if (currentTile.Equals(new Vector2(0, 17)) || currentTile.Equals(new Vector2(Controller.numberOfTilesX - 1, 17)) || currentTile.Equals(new Vector2(0, 8)) || currentTile.Equals(new Vector2(Controller.numberOfTilesX - 1, 8)))
            {
                return currentTile;
            }
