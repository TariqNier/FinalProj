...
namespace Pacman_2
{
    ...
    public class Game1 : Game
    {
        ...
        public static Texture2D MAZE33;
        ...
        public static SpriteSheet spriteSheet3; // for logo2
        public static SpriteSheet spriteSheet4; // for maze
        public static SpriteSheet spriteSheet5; // for PACWOMAN or MS PACMAN
        ...
        protected override void LoadContent()
        {
            ...
            MAZE33 = Content.Load<Texture2D>("MAZE33");
            spriteSheet1 = new SpriteSheet(GeneralSprites1);
            spriteSheet2 = new SpriteSheet(GeneralSprites);
            spriteSheet3 = new SpriteSheet(logo2);
            spriteSheet4 = new SpriteSheet(EMPTY_MAZE3);
            spriteSheet5 = new SpriteSheet(MAZE33);

            Menu.setPacmanLogo = Content.Load<Texture2D>("logo2");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (gameController.gameState == Controller.GameState.Normal)
            {
                ...
                if (!pacmanDeathAnimation.IsPlaying)
                    Pacman.Draw(_spriteBatch, spriteSheet5); // what draws the player
                if (hasPassedInitialSong || score == 0)
                    if (!pacmanDeathAnimation.IsPlaying)
                        gameController.drawGhosts(inky, blinky, pinky, clyde, _spriteBatch, spriteSheet1); // what draws the ghosts

                pacmanDeathAnimation.Draw(_spriteBatch, spriteSheet1, gameController.pacmanDeathPosition); // what draws the death animation
